...
export { default as CustomEvent, CustomEventInit } from "./CustomEvent";
export { default as Document, XMLDocument, ElementCreationOptions } from "./Document";
...
export { default as Element, ShadowRootInit } from "./Element";
export { default as Event, EventInit } from "./Event";
export { default as EventTarget, EventListener, EventListenerOptions, AddEventListenerOptions } from "./EventTarget";
export { default as HTMLCollection } from "./HTMLCollection";
export { default as MutationObserver, MutationCallback, MutationObserverInit } from "./MutationObserver";
export { default as MutationRecord } from "./MutationRecord";
export { default as NamedNodeMap } from "./NamedNodeMap";
export { default as Node, GetRootNodeOptions } from "./Node";
...
export { default as StaticRange, StaticRangeInit } from "./StaticRange";
...
export * as mixin from "./mixin/index";
